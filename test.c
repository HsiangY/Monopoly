...
int rule(int n)		//遊戲規則 
{
	...
	printf("■                                                                                              ■\n");
	printf("■            交易                                                                              ■\n");
	printf("■            *行走到一般星球，且該星球無人占領，則可選擇是否購買                               ■\n");
	printf("■            *若再次走到自己已占領的星球，則可選擇是否升級該星球(升級上限為3)                  ■\n");
	printf("■            *若行走到其他玩家佔領的星球，需繳交過路費(與該星球等級相應金額)該星球的占領者     ■\n");
	printf("■                                                                                              ■\n");
	printf("■            破產                                                                              ■\n");
	printf("■            *玩家財產歸零可選則變賣自己的星球換取金錢，或直接放棄退出遊戲                     ■\n");
